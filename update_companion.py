...
FILE_PATH = r"c:\Dev_Projects\Financial Companion\apps\web\app\companion\page.tsx"
...
const SUGGESTED_PROMPTS = [
  ...
  { text: "কোন ব্যাংকে ভালো FD রেট আছে?",         icon: "🏦" },
  { text: "আমার কাছে কোথায় ব্যাংক আছে?",          icon: "📍" },
  { text: "ব্যক্তিগত লোন নিতে কী লাগবে?",          icon: "📄" },
  { text: "যদি মাসে ১০০০ টাকা বেশি দিই?",          icon: "🎯" },
];
...
export default function CompanionPage() {
  ...
  const playSynthesis = async (text: string) => {
    try {
      ...
      const res = await fetch(`${apiUrl}/api/voice/synthesise`, {
        method: "POST",
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", height: "calc(100vh - 120px)" }}>
      ...
      <div style={{ padding: "12px", borderTop: "1px solid var(--color-border)", background: "var(--color-surface)" }}>
        <form onSubmit={handleSubmit} style={{ display: "flex", gap: "8px", alignItems: "center" }}>
          ...
          <button 
            ...
            aria-label={isRecording ? "রেকর্ডিং বন্ধ করুন" : "ভয়েস রেকর্ড করুন"}
          >
            {isRecording ? "⏹" : "🎤"}
          </button>
        ...
        <div style={{ textAlign: "center", marginTop: "8px", fontSize: "11px", color: "var(--color-gray-500)" }}>
